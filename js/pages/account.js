...
function loadCurrentFlatTab(container, userProfile) {
  ...
  content.innerHTML = `
    ...
    <div class="property-card list-view">
      ...
      <div class="property-actions">
        <button class="action-button info" aria-label="More information" onclick="showPropertyDetails(${property.id})">
          <svg viewBox="0 0 24 24">
  ...
  if (infoButton) {
    infoButton.addEventListener('click', (e) => {
      e.stopPropagation();
      showPropertyDetails(userProfile.documents.flattingHistory[0].id);
    });
  }
