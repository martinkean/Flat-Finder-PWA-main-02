...
export function showProfileEditOverlay(userProfile) {
  ...
  if (!profileEditOverlay) {
      ...
      <div class="profile-edit-content">
        ...
        <div class="profile-edit-form">
          ...
          <div class="form-group">
            ...
            <select>
              <option value="1" ${userProfile.yearOfStudy === 1 ? 'selected' : ''}>First Year</option>
              <option value="2" ${userProfile.yearOfStudy === 2 ? 'selected' : ''}>Second Year</option>
              <option value="3" ${userProfile.yearOfStudy === 3 ? 'selected' : ''}>Third Year</option>
              <option value="4" ${userProfile.yearOfStudy === 4 ? 'selected' : ''}>Fourth Year</option>
              <option value="5" ${userProfile.yearOfStudy === 5 ? 'selected' : ''}>Fifth Year</option>
              <option value="6" ${userProfile.yearOfStudy === 6 ? 'selected' : ''}>Postgraduate</option>
            </select>
          </div>
        </div>
    ...
    const cancelButton = profileEditOverlay.querySelector('.cancel-button');
    const saveButton = profileEditOverlay.querySelector('.save-button');
